 ...
 public class UserControllerTest {
     ...
     @Test
     @WithMockUser(username = "testUser", authorities = {"ADMIN", "STUDENT"})
     void testAuthenticateUser() throws Exception {
         User authRequest = new User();
         authRequest.setUsername("testUser");
         // Include any other required fields for authentication

         // Stub the authentication service appropriately
     ...
     void testRegisterUser() throws Exception {
         ...
         mockMvc.perform(post("/api/users/register")
                 ...
                 .andExpect(header().string("Location", endsWith("/api/users/" + registeredUser.getId())))
